...
export class EventListActions {
    ...
    static readonly SELECT_TEAM_FAIL = 'EVENTS/SELECT_TEAM_FAIL'
    static readonly SELECT_TEAM_DONE = 'EVENTS/SELECT_TEAM_DONE'
    ...
    @dispatch()
    static selectTeamFail(error): ReduxAction<any> {
        return {
            type: EventListActions.SELECT_TEAM_FAIL,
            payload: error
        }
    }
}
